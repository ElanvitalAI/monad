...
/** 설치본 패키지가 사는 자리 — 설치기(`monadagent` · tarball) ⊕ npm(`@elanvitalai/monad` · 09-26 공개 스코프).
 *  ⛔ 한 곳에만 둔다: 이 목록을 모르는 판정은 npm 설치본을 «트리»로 읽어 작업 폴더의 우주로 떨어진다. */
export const INSTALLED_PACKAGE_MARKERS = ['/node_modules/monadagent', '/node_modules/@elanvitalai/monad'] as const;
