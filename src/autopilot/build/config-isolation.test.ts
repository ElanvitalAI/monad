...
// SHA 프로토콜(reference_test_isolation_sha_protocol): 메인 ~/.monad/config.json 의 SHA 를
...
const MAIN_CONFIG = join(homedir(), '.monad/config.json');
