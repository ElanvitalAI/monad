...
//
// ROADMAP-elanous-builtin-autopilot-cascade §MB-1.
//
...
// the ACP backend list and made the elanous-builtin (NEXUS in-process
// LLM rotation) path unreachable — iOS chip = elanous fell back to
// "claude" instead of running on elanous's native rotation.
//
...
// elanous-builtin one) provide identical onUpdate semantics — the
 ...
 *   - `ElanousBuiltinTurnRunner` (MB-3, separate file) — wraps the NEXUS
