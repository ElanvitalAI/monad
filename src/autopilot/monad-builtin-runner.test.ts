// src/autopilot/monad-builtin-runner.test.ts
//
// ROADMAP-monad-builtin §MB-3 — MonadBuiltinTurnRunner unit tests.
//
...
import {
  ...
  MonadBuiltinTurnRunner,
} from './monad-builtin-runner.js';
...
describe('MonadBuiltinTurnRunner — initialization', () => {
...
describe('MonadBuiltinTurnRunner — prompt cancel wiring', () => {
...
describe('MonadBuiltinTurnRunner — block conversion', () => {
...
describe('MonadBuiltinTurnRunner — core-turn stopReason mapping', () => {
