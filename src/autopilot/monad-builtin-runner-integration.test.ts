// src/autopilot/monad-builtin-runner-integration.test.ts
//
// MB-17 (2026-05-15) — MonadBuiltinTurnRunner integration mock test.
//
...
const { MonadBuiltinTurnRunner } = await import('./monad-builtin-runner.js');

function noopDispatch() {
  return async () => ({ output: 'mock-tool-result' });
}

describe('MonadBuiltinTurnRunner — integration (mocked runCoreTurn)', () => {
