// Monad Pastel Default — the house brand pastel (light).
//
...
// distinctly "monad". Semantic colors respect DD-IDX-15 so PFC
...
export const MONAD_PASTEL_DEFAULT: ThemeTokens = {
  name: 'monad-pastel-default',
  isDark: false,
  isPastel: true,
  colors: {
    text: palette.text,
