...
//
// PLAN-multi-surface-pty-shell M4a: the Discord flavor of the monad
...
/** Discord flavor of the monad self turn — consumed by the
...
export function makeDiscordAgentRunTurn(cfg: UserConfig): typeof runTurn {
  return makeMonadAgentRunTurn(cfg, 'discord');
}
