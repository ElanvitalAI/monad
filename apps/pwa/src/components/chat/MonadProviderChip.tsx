...
/**
 * monad(monad-builtin) backend 의 LLM provider 스위처 (2026-07-08).
 * 대표 요청: monad 선택 시 어떤 LLM provider(claude·grok 등)로 답할지. 왼쪽 backend
...
export function MonadProviderChip() {
