// WT-S-1 — `elanous/term/*` envelope codec, mirror of daemon-side
// `src/acp/elanous-extensions.ts`. Two copies because PWA is a separate
 ...
 *  `ElanousTermFramePayload`. cf. PLAN-self-observation-capture-substrate. */
...
export type ElanousTermEnvelope =
...
export function parseElanousTermEnvelope(text: string): ElanousTermEnvelope | null {
